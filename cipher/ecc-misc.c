...
_gcry_ecc_dialect2str (enum ecc_dialects dialect)
{
  ...
  switch (dialect)
	...
	case ECC_DIALECT_ED168:   str = "Ed168"; break;
  }
  return str;
}
                          ...
                          mpi_point_t G, gcry_mpi_t d)
{
  ...
  if ((ec->dialect == ECC_DIALECT_ED25519 || ec->dialect == ECC_DIALECT_ED448 || ec->dialect == ECC_DIALECT_ED168) && (ec->flags & PUBKEY_FLAG_EDDSA))
    {
      gcry_mpi_t a;
